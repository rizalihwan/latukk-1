  ...
  <header id="header" class="fixed-top  header-transparent ">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo mr-auto">
        <a href="{{ route('welcome') }}"><img src="{{ asset('landing/assets/img/logowk.png') }}" alt="logoWeb" srcset=""></a>
        <h1 class="text-light"><a href="{{ route('welcome') }}">PPDB</a></h1>
      ...
      <div class="row">
        <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          <div>
            ...
            <h2>Sekolah di SMK yang mementingkan budi pekerti dan akhlaq yang qaulan qarimah. Segera daftarkan diri anda dan bersiap dalam dunia Kerja</h2>
            <a href="{{ route('siswa.daftar') }}" class="download-btn">Daftar Sekarang <i class="fa fa-hand-point-right"></i></a>
          </div>
        </div>
        <div class="col-lg-6 d-lg-flex flex-lg-column align-items-stretch order-1 order-lg-2 hero-img" data-aos="fade-up">
          <img src="{{ asset('landing/assets/img/potoatas.png') }}" style="width: 400px; height: 490px; object-fit: cover;" class="img-fluid" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          ...
          <div class="image col-xl-5 d-flex align-items-stretch justify-content-center order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="{{ asset('landing/assets/img/logowk.png') }}" style="width: 200px; height: 200px; object-fit: cover;" class="img-fluid" alt="">
          </div>
        </div>
    ...
    <section id="gallery" class="gallery">
      <div class="container">
        ...
        <div class="owl-carousel gallery-carousel" data-aos="fade-up">
          <a href="{{ asset('landing/assets/img/gallery/gallery-1.png') }}" class="venobox" data-gall="gallery-carousel"><img src="{{ asset('landing/assets/img/gallery/gallery-1.png') }}" alt=""></a>
          <a href="{{ asset('landing/assets/img/gallery/gallery-2.png') }}" class="venobox" data-gall="gallery-carousel"><img src="{{ asset('landing/assets/img/gallery/gallery-2.png') }}" alt=""></a>
          <a href="{{ asset('landing/assets/img/gallery/gallery-3.png') }}" class="venobox" data-gall="gallery-carousel"><img src="{{ asset('landing/assets/img/gallery/gallery-3.png') }}" alt=""></a>
          <a href="{{ asset('landing/assets/img/gallery/gallery-4.png') }}" class="venobox" data-gall="gallery-carousel"><img src="{{ asset('landing/assets/img/gallery/gallery-4.png') }}" alt=""></a>
          <a href="{{ asset('landing/assets/img/gallery/gallery-5.png') }}" class="venobox" data-gall="gallery-carousel"><img src="{{ asset('landing/assets/img/gallery/gallery-5.png') }}" alt=""></a>
          <a href="{{ asset('landing/assets/img/gallery/gallery-6.png') }}" class="venobox" data-gall="gallery-carousel"><img src="{{ asset('landing/assets/img/gallery/gallery-6.png') }}" alt=""></a>
          <a href="{{ asset('landing/assets/img/gallery/gallery-7.png') }}" class="venobox" data-gall="gallery-carousel"><img src="{{ asset('landing/assets/img/gallery/gallery-7.png') }}" alt=""></a>
          <a href="{{ asset('landing/assets/img/gallery/gallery-8.png') }}" class="venobox" data-gall="gallery-carousel"><img src="{{ asset('landing/assets/img/gallery/gallery-8.png') }}" alt=""></a>
          <a href="{{ asset('landing/assets/img/gallery/gallery-9.png') }}" class="venobox" data-gall="gallery-carousel"><img src="{{ asset('landing/assets/img/gallery/gallery-9.png') }}" alt=""></a>
          <a href="{{ asset('landing/assets/img/gallery/gallery-10.png') }}" class="venobox" data-gall="gallery-carousel"><img src="{{ asset('landing/assets/img/gallery/gallery-10.png') }}" alt=""></a>
          <a href="{{ asset('landing/assets/img/gallery/gallery-11.png') }}" class="venobox" data-gall="gallery-carousel"><img src="{{ asset('landing/assets/img/gallery/gallery-11.png') }}" alt=""></a>
          <a href="{{ asset('landing/assets/img/gallery/gallery-12.png') }}" class="venobox" data-gall="gallery-carousel"><img src="{{ asset('landing/assets/img/gallery/gallery-12.png') }}" alt=""></a>
        </div>
  ...
  <footer id="footer">
    <div class="container py-4">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://rizalihwan.netlify.app/">Rizal Ihwan</a>
      </div>
    </div>
  </footer><!-- End Footer -->
